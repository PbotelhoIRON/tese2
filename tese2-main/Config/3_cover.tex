...
%-------------------------------------------------------------------
\nttitle(main,en){Control and Optimization of High-Pressure Compressor Blade Dimensions and Clearances}%
...
%         You may use "\\" to force line breaks
%-------------------------------------------------------------------
\nttitle(sub,en){Introdução à dissertação}%
...
%-------------------------------------------------------------------
\ntauthorname(m){Pedro Miguel Martins Botelho}{Pedro Botelho}

%-------------------------------------------------------------------
% AUTHOR previous degree
% SYNTAX: \ntauthordegree{degree}
%-------------------------------------------------------------------
\ntauthordegree(en){BSc in \embrace{Mechanical Engineering Sciences}}
...
%         \ntdate{year}
%-------------------------------------------------------------------
\ntdate{\embrace{2025},\embrace{february}}
...
%         You may use "\\" to force line breaks
% Advisers(s)
\ntaddperson{adviser}(a,f){João Fradinho, Assistant Professor, NOVA University Lisbon}
% Co-advisers(s)
%\ntaddperson{adviser}(c,m){António Ferreira, , TAP Air Portugal}
